...
function TurfDetail() {
    ...
    useEffect(() => {
        ...
        axiosInstance({
            ...
            .then(res => setTurf(res.data.data))
            .catch(err => toast.error(err?.response?.data?.message || 'Failed to fetch turf details'))
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mt-6 relative">
                        <h1 className="text-4xl font-bold text-gray-900">{turf.name}</h1>
                        <span className={`absolute right-0 mt-2 sm:mt-0 px-3 py-1.5 rounded-full text-sm font-semibold ${isOpen ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
